    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold text-foreground">MealPrepFriend</h1>
        ...
        <button
          ...
          className="mb-4 flex w-full items-center justify-center gap-3 rounded-lg border-2 border-border bg-card px-6 py-3 text-base font-medium text-foreground transition-colors hover:bg-muted active:scale-[0.98]"
        >
